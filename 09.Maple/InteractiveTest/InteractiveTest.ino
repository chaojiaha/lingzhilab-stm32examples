...
void cmd_serial1_serial2(void) {
    HardwareSerial *serial_1_and_3[] = {&Serial1, &Serial2};

    Serial.println("Testing 57600 baud on USART1 and USART2. "
                      "Press any key to stop.");
    usart_baud_test(serial_1_and_3, 2, 57600);
    Serial.read();

    Serial.println("Testing 115200 baud on USART1 and USART2. "
                      "Press any key to stop.");
    usart_baud_test(serial_1_and_3, 2, 115200);
    Serial.read();

    Serial.println("Testing 9600 baud on USART1 and USART2. "
                      "Press any key to stop.");
    usart_baud_test(serial_1_and_3, 2, 9600);
    Serial.read();

    Serial.println("Resetting USART1 and USART2...");
    Serial1.begin(BAUD);
    Serial2.begin(BAUD);
}
